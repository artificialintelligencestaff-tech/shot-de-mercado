...
Proposito:
    Ejecutar las 3 herramientas de CoinLobster UNA POR UNA.
    Cada resultado se guarda en su propio archivo pequeno.
    Esto evita truncamiento del motor Nemotron 3.5 Lightning.
"""
...
ONCHAIN_DIR = PROJECT_ROOT / "01_Datos_Crudos" / "onchain" / "coinlobster"
...
def main():
    ...
    print(f"[YIN] CoinLobster porciones - {ts}")
    ...
    print("[YIN] Script 09f finalizado.")
